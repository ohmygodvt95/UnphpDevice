 ...
 * @author Admins
 */
public class FanUI extends JFrame implements PropertyChangeListener, ActionListener {
    ...
    private void init() {
        ...
        AutoResizeIcon.setIcon(label, "quatdong.png");
        add(label);
        add(but);
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        if (pce.getPropertyName().equals("status")) {
            ...
            if (status) {
                AutoResizeIcon.setIcon(label, "quatmo.png");
            } else {
                AutoResizeIcon.setIcon(label, "quatdong.png");
            }
            repaint();
